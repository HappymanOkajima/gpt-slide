...
### 1.スライドの自動生成
ChatGPTのようにプロンプトで指示を与えます。生成したいページ数とAIの創造性を指定可能です。タイトルページまたは各ページに画像も合わせて生成することもできます（各ページに追加すると相応の時間がかかります）。生成されたスライドはアクティブなスライドの直後に順次追加されます。

![image](https://github.com/HappymanOkajima/gpt-slide/assets/6194144/817adb2a-edee-47d4-a4f7-aeab70db2955)
